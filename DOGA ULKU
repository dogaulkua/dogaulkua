...
### 🏥 [DeepVision](https://github.com/dogaulkua/deepvision) - *Mercedes-Benz beVisioneers Fellowship*
...
### 🔬 [Deepfake Detection & ToS Risk Analysis](https://github.com/dogaulkua/deepfake-tos-research) - *Published Research IDAP'25*
...
### 🌍 [Green Equilibrium](https://github.com/dogaulkua/Green-Equilibrium-Analysis-Presentation) - *NASA 1st Place & Global Nominee*
...
### Tools & Platforms
![IBM Z](https://img.shields.io/badge/IBM_Z-0530AD?style=flat&logo=ibm&logoColor=white)
...
- 🏅 **IBM Z Superstar & ACE Tiers**
- 📚 **TÜBİTAK 2209-B Research Grant**

---

## 📝 Latest Research

**Ülkü, D., & Emek, S. (2025).** *Deepfake Detection and ToS Risk Analysis Using NLP: A Multimodal Framework.* 
In Proceedings of the 9th International Artificial Intelligence and Data Processing Symposium (IDAP'25), 
Malatya, Türkiye & Seoul, Republic of Korea.

---

## 🌱 Current Focus

- 🔭 Working on **enterprise AI solutions** at AI Business School
- 🧪 Researching **AI-driven object avoidance** for Martian rovers (DEEP SPACE INITIATIVE)
